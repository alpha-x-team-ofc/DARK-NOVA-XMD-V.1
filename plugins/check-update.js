...
cmd({
  ...
  try {
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/alpha-x-team/DARK-NOVA-XMD';

    // Check update status
    let updateMessage = `✅ Your DARK-NOVA-XMD bot is up-to-date!`;
    if (localVersion !== latestVersion) {
      updateMessage = `🚀 Your DARK-NOVA-XMD bot is outdated!
...
Use *.update* to update.`;
    ...
    const statusMessage = `🌟 *Good ${new Date().getHours() < 12 ? 'Morning' : 'Night'}, ${pushname}!* 🌟\n\n` +
      ...
      `📝 *Changelog:*\n${latestChangelog}\n\n` +
      `⭐ *GitHub Repo:* ${githubRepo}\n👤 *Owner:* [GotarTech](https://github.com/alpha-x-team)\n\n${updateMessage}\n\n🚀 *Hey! Don't forget to fork & star the repo!*`;
