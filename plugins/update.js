...
cmd({
    ...
    try {
        await reply("🔍 Checking for DARK-NOVA-XMD updates...");

        // Fetch the latest commit hash from GitHub
        const { data: commitData } = await axios.get("https://github.com/alpha-x-team-ofc");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your DARK-NOVA-XMD bot is already up-to-date!");
        }
        ...
        const { data: zipData } = await axios.get("https://github.com/alpha-x-team-ofc", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "DARK-NOVA-XMD-main");
